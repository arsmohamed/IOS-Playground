...
print("The games finial score is \(gameScore)")
...
let averageKevekScire = Double(levelScoreDifference) / Double(levels)
print("The level's average score is \(averageKevekScire)")
